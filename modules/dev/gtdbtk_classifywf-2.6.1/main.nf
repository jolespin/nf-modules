process GTDBTK_CLASSIFYWF {
    ...
    container "${ workflow.containerEngine == 'singularity' && !task.ext.singularity_pull_docker_container ?
        ...
        'quay.io/biocontainers/gtdbtk:2.6.1--pyh1f0d9b5_2' }"

    input:
    tuple val(meta)   , path("bins/*")
    tuple val(db_name), path(db)
    val use_pplacer_scratch_dir
    path skani_sketch_dir
    val extension
    ...
    def ani_screening_mode       = skani_sketch_dir ? "--skani_sketch_dir ${skani_sketch_dir}" : "--skip_ani_screen"
